...
\node [coordb, right=of p3]  (c2)  {}; \cmark{2}   
...
\path (p3.east) to node [near start, yshift=1em] {} (c1); 
  \draw [o->, blue, dotted, thick] ([yshift=-1.2em]p3.east) -- ([yshift=-1.2em]c1) |- (p5);

\path (p3.east) to node [near start] {} (c2); 
  \draw [o->, red, dotted, thick] ([yshift=1.2em]p3.east) -- ([yshift=1.2em]c2) |- ([yshift=1.2em]p6);

\path (p4.east) to node [near start] {} (c3); 
  \draw [o->, green, dotted, thick] (p4.east) -- (c3) |- ([yshift=-1.2em]p6);
% -------------------------------------------------
% -------------------------------------------------
