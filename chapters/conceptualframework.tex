...
través de un archivo llamado DICOMDIR que almacena la información acerca de los
archivos DICOM en un determinado. DICOMDIR juega el rol de una pequeña base de
...
cuatro niveles: Paciente, Estudio, Serie e Imagen.

Los archivos DICOM también contienen metainformación organizada en forma de
etiquetas, en la Tabla \ref{dicom:tags} podemos ver algunas de las etiquetas
principales de un archivo DICOM. 
...
BIRADS\footnote{Breast Imaging Reporting and Data System Atlas}
\cite{reston2003birads} provee la terminología básica y un sistema de
clasificación para los estudios mamográficas. Fue creado por el ACR para
...
Entre las lesiones descritas en la cuarta edición de BIRADS tenemos las
\textit{masas}, las \textit{asimetrías}, las \textit{asimetrías focales}, las
\textit{asimetrías globales}, las \textit{calcificaciones} y las
\textit{microcalcificaciones}.

Una \textit{masa} es una estructura tridimensional usualmente visible en dos
proyecciones ortogonales. Las \textit{asimetrías} son ..

\textit{Calcificaciones} y \textit{microcalcificaciones}, que son depósitos de
calcio.
