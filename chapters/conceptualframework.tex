...
Aunque es el recurso más viejo y no tiene soporte actualmente mini-MIAS\footnote{The Mammographic Image
Analysis Society Digital Mammogram Database} sigue siendo \cite{sucklingmini} 

DDSM\footnote{The Digital Database for Screening Mammography}
