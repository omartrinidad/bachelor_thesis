...
En las imágenes mamográficas existen cuatro tipos de ruido: cuántico (también
conocido como ruido Poisson, ya que puede ser descrito por esta distribución),
electrónico fijo, señales secundarias y quanta secundaria indirecto.
\cite{hashimoto2008practical}.  es el ruido que más presencia tiene en imágenes
mamográficas. Romualdo \cite{romualdopre, dos2009mammography} propone un método
para su reducción.
...
Frecuencia para mejorar las imágenes. 

se utiliza la transformada de Anscombe
