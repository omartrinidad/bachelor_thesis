...
\begin{figure}[h]
    ...
    \subfloat[Contraste modificado\label{hist:d}]{\includegraphics[height=40mm]{images/histo/completerange.jpg}}
    ...
    \subfloat[Histograma de \protect\subref{hist:d}]{\includegraphics[height=40mm]{images/histo/completerange-histo.jpg}}
...
{\small
    ...
    AMDI      & 967  & 3369   & MLO \& CC & DICOM & Italia         & 2002 & no  & yes \\[3.1ex] 
    \hline
    \end{tabular}
}
\end{center}
