...
\begin{figure}[h]
    ...
    %\subfloat[150 dpi]{\includegraphics[height=40mm]{images/dpi/dpi150.jpg}}
    %\subfloat[125 dpi]{\includegraphics[height=40mm]{images/dpi/dpi125.jpg}}
    %\subfloat[100 dpi]{\includegraphics[height=40mm]{images/dpi/dpi100.jpg}}
    %\subfloat[75 dpi]{\includegraphics[height=40mm]{images/dpi/dpi75.jpg}}
    %\bigskip

    \subfloat[50 dpi]{\includegraphics[height=40mm]{images/dpi/dpi50.jpg}}
    \subfloat[25 dpi]{\includegraphics[height=40mm]{images/dpi/dpi25.jpg}}
    \subfloat[10 dpi]{\includegraphics[height=40mm]{images/dpi/dpi10.jpg}}
    \subfloat[5 dpi]{\includegraphics[height=40mm]{images/dpi/dpi5.jpg}}

  \caption[resolución]{Imagen de Lenna obtenida de \textit{The USC-SIPI Image Database}
...
\begin{figure}[h]
    \centering
    %\subfloat[256 niveles de grises]{\includegraphics[height=40mm]{images/lenna/lenna256.jpg}}
    %\subfloat[128 niveles de grises]{\includegraphics[height=40mm]{images/lenna/lenna128.jpg}}
    %\subfloat[64 niveles de grises]{\includegraphics[height=40mm]{images/lenna/lenna64.jpg}}
    %\subfloat[32 niveles de grises]{\includegraphics[height=40mm]{images/lenna/lenna32.jpg}}
    %\bigskip
    \subfloat[16 niveles de grises]{\includegraphics[height=40mm]{images/lenna/lenna16.jpg}}
    \subfloat[8 niveles de grises]{\includegraphics[height=40mm]{images/lenna/lenna8.jpg}}
    \subfloat[4 niveles de grises]{\includegraphics[height=40mm]{images/lenna/lenna4.jpg}}
    \subfloat[2 niveles de grises]{\includegraphics[height=40mm]{images/lenna/lenna2.jpg}}

  \caption[Diferentes resoluciones]{Diferentes resoluciones. Imagen de Lenna obtenida de
...
examinar el contraste de una imagen.

En la Figura~\ref{fig:histograms} se puede ver

\begin{figure}[h]
    \centering

    \subfloat[Bajo contraste\label{hist:a}]{\includegraphics[height=40mm]{images/histo/rightskewed.jpg}}
    \subfloat[Contraste normal\label{hist:b}]{\includegraphics[height=40mm]{images/histo/mandril.jpg}}
    \subfloat[Alto contraste\label{hist:c}]{\includegraphics[height=40mm]{images/histo/leftskewed.jpg}}

    \bigskip

    \subfloat[Histograma de \protect\subref{hist:a}]{\includegraphics[height=40mm]{images/histo/histogram-right.jpg}}
    \subfloat[Histograma de \protect\subref{hist:b}]{\includegraphics[height=40mm]{images/histo/histogram-mandril.jpg}}
    \subfloat[Histograma de \protect\subref{hist:c}]{\includegraphics[height=40mm]{images/histo/histogram-left.jpg}}

  \caption[Histogramas]{La misma imagen con diferentes contrastes y su
  respectivo histograma. En \protect\subref{hist:a} se visualiza la imagen con
...
\begin{figure}[h]
  ...
  imagen original, \protect\subref{muscle:b} muestra la remoción del músculo y 
  \protect\subref{muscle:c} es un acercamiento}
  \label{fig:muscle}
\end{figure}
...
{\small
    ...
    GPCalma   & 967  & 3369   & MLO \& CC & DICOM & Italia         & 2002 & no  & yes \\[4ex] 
    AMDI      & 967  & 3369   & MLO \& CC & DICOM & Italia         & 2002 & no  & yes \\[4ex] 
    \hline
    \end{tabular}
}
\end{center}
