...
posición de ese arreglo almacena un valor númerico.

La escala de grises de una imagen es cuyo \textit{modo de color} es  . Son
imágenes \textit{en blanco y negro}. En la imagen \ref{grayscales} podemos ver
la misma imagen en diferente escala de grises.
...
Uno de los usos más \cite{suetens2009fundamentals}
