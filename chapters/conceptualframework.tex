...
son: preprocesamiento, selección de regiones de interés (ROI\footnote{Regions
of Interest}), extracción de características y finalmente un algoritmo de
...
Una gran cantidad de trabajos de investigación se han desarrollado en el campo
del preprocesamiento de imágenes mamográficas. En esta sección hacemos una
revisión de varios enfoques, algunos de los cuales se rescataron para crear un
método híbrido que combina las fortalezas de estos. 
