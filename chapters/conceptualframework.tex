...
\begin{figure}[h]
    ...
    \subfloat[Contraste modificado\label{hist:d}]{\includegraphics[height=36mm]{images/histo/completerange.jpg}}
...
\begin{figure}[h]
    ...
    \subfloat[Tomografía]{\includegraphics[height=36mm]{images/computed-tomography.png}}
    \hspace{1cm}
    \subfloat[Resonancia magnética]{\includegraphics[height=36mm]{images/computed-tomography.png}}
    \hspace{1cm}
    \subfloat[Ultrasonido]{\includegraphics[height=36mm]{images/computed-tomography.png}}
