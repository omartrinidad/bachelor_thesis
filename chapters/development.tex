...
\begin{figure}[h!]
  ...
  \caption{Close-up of a mammogram. \protect\subref{contr:a} Original lesion area,
...
\begin{figure}[h]
  \begin{center}
    \subfloat[\label{comp:a}]{\includegraphics[height=30mm]{images/compress/original-mammogram-16bits}}
    \hspace{12pt}
    \subfloat[\label{comp:b}]{\includegraphics[height=30mm]{images/compress/original-image-histogram}}
    \hspace{12pt}
    \subfloat[\label{comp:c}]{\includegraphics[height=30mm]{images/compress/shrunk-histogram}}
    \hspace{12pt}
    \subfloat[\label{comp:d}]{\includegraphics[height=30mm]{images/compress/dark-mammogram}}
  \end{center}

  \caption{Shrinking procedure. \protect\subref{comp:a} original mammogram,
  \protect\subref{comp:b} histogram of \protect\subref{comp:a},
  \protect\subref{comp:c} histogram shown in \protect\subref{comp:b} after
  being shrunk, and \protect\subref{comp:d} is the dark image generated from
...
\begin{figure}[h]
  \begin{center}
    ...
    \hspace{12pt}
    \subfloat[\label{comp:f}]{\includegraphics[height=30mm]{images/compress/compressed-mammogram-8bits}}
    \hspace{12pt}
    \subfloat[\label{comp:g}]{\includegraphics[height=30mm]{images/compress/compressed-mammogram-histogram}}
  \end{center}

  \caption{\protect\subref{comp:e} histogram generated from the dark mammogram
  shown in Fig. \protect\ref{comp:d}, \protect\subref{comp:f}  8-bit mammogram
  obtained from \protect\subref{comp:e}, \protect\subref{comp:g} histogram of
  image \protect\subref{comp:f}, which is similar to histogram shown in Fig.
  \ref{comp:b}}. 
