...
\texttt{PyDICOM}. Se removieron los datos privados de los pacientes y los datos
...
% thresholding
Aplicamos un método de tres fases para lograr la reducción: binarización,
...
\begin{figure}[h]
    ...
    \subfloat[150 dpi]{\includegraphics[height=35mm]{images/dpi150.jpg}}
    \subfloat[125 dpi]{\includegraphics[height=35mm]{images/dpi125.jpg}}
    \subfloat[25 dpi]{\includegraphics[height=35mm]{images/dpi25.jpg}}
    \subfloat[50 dpi]{\includegraphics[height=35mm]{images/dpi50.jpg}}
