...
abubaker2007efficient}. Esta técnica tiene como objetivo comprimir una imagen
...
La Figura~\ref{comp:a} es la imagen obtenida de la fase anterior y su
...
\begin{figure}[h]
  ...
  \caption[Método de encogimiento]{Método de encogimiento. En \protect\subref{comp:a} se visualiza la imagen de entrada,
